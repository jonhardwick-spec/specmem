...
const HOOKS_TO_DEPLOY = [
  ...
  'file-claim-enforcer.js',             // Enforces claim_task before Read/Edit/Write for agents
  'input-aware-improver.js',
  'search-reminder-hook.js',            // Reminds Claude to use find_code_pointers
  'smart-context-hook.js',
  'smart-search-interceptor.js',
  'specmem-context-hook.js',
  'specmem-drilldown-hook.js',
  'specmem-drilldown-setter.js',
  'specmem-precompact.js',
  'specmem-session-start.js',           // Session start hook (.js version)
    ...
    "UserPromptSubmit": [
      {
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/specmem-drilldown-hook.js`,
            "timeout": 30,
      ...
      },
      {
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/input-aware-improver.js`,
            "timeout": 5,
            "env": BASE_ENV
          }
        ]
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/agent-loading-hook.js`,
            "timeout": 10,
      ...
      },
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/team-comms-enforcer.cjs`,
            "timeout": 5,
      ...
      },
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/smart-context-hook.js`,
            "timeout": 8,
            "env": {
              ...BASE_ENV,
      ...
      },
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/search-reminder-hook.js`,
            "timeout": 3,
      ...
      },
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/file-claim-enforcer.js`,
            "timeout": 5,
      ...
      },
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/agent-output-interceptor.js`,
            "timeout": 3,
    ...
    "SessionStart": [
      {
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/specmem-session-start.cjs`,
            "timeout": 30,
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/task-progress-hook.js`,
            "timeout": 10,
      ...
      },
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/post-write-memory-hook.cjs`,
            "timeout": 10,
            "env": BASE_ENV
          }
        ]
    ...
    "SubagentStart": [
      {
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/subagent-loading-hook.js`,
            "timeout": 5,
    ...
    "Stop": [
      {
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/specmem-stop-hook.js`,
            "timeout": 3,
            "env": {
              "SPECMEM_PROJECT_PATH": "${cwd}"
            }
    ...
    "PreCompact": [
      {
        "hooks": [
          {
            "type": "command",
            "command": `node ${CLAUDE_HOOKS_DIR}/specmem-precompact.js`,
            "timeout": 60,
...
function copyHooks() {
  ...
  if (!fs.existsSync(CLAUDE_HOOKS_DIR)) {
    ...
    console.log(`${C.green}✓${C.reset} Created ${CLAUDE_HOOKS_DIR}`);
  }
