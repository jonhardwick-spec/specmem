...
class EmbeddingServer:
    ...
    def start(self):
        ...
        max_workers = int(os.environ.get('SPECMEM_EMBEDDING_MAX_WORKERS', '10'))
        ...
        try:
            while not self.shutdown_requested:
                try:
                    ...
                    conn.settimeout(30)  # Set timeout on individual connection to prevent threads hanging forever
