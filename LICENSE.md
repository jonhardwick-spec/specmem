...
<head>
<style>
.danger-box { background: linear-gradient(135deg, #1a0000 0%, #330000 100%); border: 3px solid #ff0000; padding: 20px; margin: 20px 0; border-radius: 8px; }
.danger-header { color: #ff3333; font-size: 24px; font-weight: bold; text-shadow: 0 0 10px #ff0000; }
.neon-cyan { color: #00ffff; text-shadow: 0 0 5px #00ffff, 0 0 10px #00ffff; }
.neon-magenta { color: #ff00ff; text-shadow: 0 0 5px #ff00ff, 0 0 10px #ff00ff; }
.neon-orange { color: #ff6600; text-shadow: 0 0 5px #ff6600, 0 0 10px #ff6600; }
</style>
</head>
</html>
...
║                                                                                  ║
║   ├─ EXPRESSLY PROHIBITED under Section 9.5.3 of this License                   ║
║   ├─ A VIOLATION of Anthropic's own Terms of Service (as stated above)          ║
║   ├─ Subject to DAMAGES of $1,000,000+ per model trained (Section 9.5.3(d))     ║
