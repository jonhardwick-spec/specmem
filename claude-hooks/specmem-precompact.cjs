...
const DB = {
  ...
  name: specmemPaths.expandCwd(process.env.SPECMEM_DB_NAME) || 'specmem',
  user: specmemPaths.expandCwd(process.env.SPECMEM_DB_USER) || 'specmem',
  pass: specmemPaths.expandCwd(process.env.SPECMEM_DB_PASSWORD) || 'specmem'
};
