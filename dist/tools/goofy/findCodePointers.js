...
export class FindCodePointers {
    ...
    inputSchema = {
        ...
        properties: {
            ...
            includeMemoryLinks: {
                type: 'boolean',
                default: true,
                description: 'Link code to related memories with attribution. Shows "requested by user" or "implemented by claude" for each code result. Default: true.'
            },
    ...
    async execute(params) {
        ...
        try {
            ...
            // This correlates code with related memories and shows "requested by user" or "implemented by claude"
