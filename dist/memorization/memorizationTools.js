/**
 * memorizationTools.ts - MCP Tools for Auto-Memorization
 *
 * yooo these are THE TOOLS that let the assistant remember what it wrote
 * no more massive explores because the system KNOWS what was created
 *
 * Tools:
 * - remember_what_i_wrote - manually store AI-generated code
 * - what_did_i_write_for - search stored code semantically
 * - all_my_code - list all code that was written
 * - code_history - get version history for a file
 * - why_did_i_write_this - get context for why code was written
 */
import { logger } from '../utils/logger.js';
/**
 * RememberWhatIWroteTool - manually store code that was just written
 *
...
export class RememberWhatIWroteTool {
    ...
    description = 'Manually store code that was just written. Call this AFTER using Write/Edit/NotebookEdit to remember what you created and why.';
    inputSchema = {
        type: 'object',
        properties: {
            filePath: {
...
/**
 * WhatDidIWriteForTool - semantic search for code that was written
 *
...
/**
 * AllMyCodeTool - list all code that was written
 *
 * skids cant find this code but the system can lmao
 ...
 *
 * fr fr helps understand the decisions made
...
/**
 * CodeStatsTool - get statistics about stored code
 *
 * how much has been written? lets see the stats
 */
